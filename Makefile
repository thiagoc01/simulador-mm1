...
OBJ1 = simulador1_mm1.o geracao_tempos.o estatisticas.o metricas.o
OBJ2 = simulador2_mm1.o requisicao.o geracao_tempos.o estatisticas.o metricas.o
OBJ3 = simulador3_mm1.o evento.o requisicao.o geracao_tempos.o estatisticas.o metricas.o
TARGET = simulador

simulador1 : estatisticas geracao_aleatorios simulador1_compilacao_objs simulador1_compilacao clean
...
simulador2 : estatisticas geracao_aleatorios simulador2_compilacao_objs simulador2_compilacao clean
